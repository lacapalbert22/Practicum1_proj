...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="user_name" placeholder="Enter Company Name" value="<?php echo $username; ?>" /></td>
    </tr>
    
    <tr>
    	<td><label class="control-label">Company Desc</label></td>
        <td><input class="form-control" type="text" name="user_job" placeholder="Enter Description" value="<?php echo $userjob; ?>" /></td>
    </tr>
    
    <tr>
    	<td><label class="control-label">Company Logo</label></td>
