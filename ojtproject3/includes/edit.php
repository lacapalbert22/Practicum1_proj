...
?>
  ...
  <button class="btn btn-danger" type="submit" formaction="../schedule.php"><span class="glyphicon glyphicon-remove-sign"></span> Cancel</button>
  </form>
...
?>
  ...
  Available Slots: <input class="form-control" type="text" name="newSlots" value="<?php echo $row[5];?>"><br>
  <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-edit"></span> Edit</button>
  <button class="btn btn-primary" type="submit" formaction="../schedule.php"><span class="glyphicon glyphicon-remove-sign"></span> Cancel</button>
  </form>
