...
<!-- Modal -->
<div class="modal fade" id="addsched" tabindex="-1" role="dialog" aria-labelledby="addshed" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php
        ...
        <input class="form-control" type="text" name="companydesc" placeholder="Description"required><br>
        Venue:<br> 
...
<div class="container">
        ...
        echo'<img src="images/company/'.$row['company_logo'].'" style="max-height: 100px; max-width: 300px;min-height: 100px; min-width: 300px; background-color:white;border-radius:10px;padding:10px;">';
          ...
          <button type="button" class="btn btn-default" data-toggle="modal" data-target="#deletesched"><span class="glyphicon glyphicon-remove-circle"></span> Delete
          </button>
        <!-- Modal -->
