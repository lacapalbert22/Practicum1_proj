...
<div class="container">
<center style="font-size: 55px; font-family: 'Lobster Two', cursive; font-weight: bold;">Archives</center>
<hr>
</div>
...
?>
        ...
        <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" style="color:black;font-family: 'Raleway';" >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLongTitle">Delete this event</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
